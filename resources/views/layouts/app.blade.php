...
<html xml:lang="zh-Hans" lang="zh-Hans">
    ...
    <head>
        ...
        <!--网站关键词、描述添加-->
        <title>bodys</title>
        <meta name="Keywords" content="杂谈,赵老师博客">
        <meta name="description" content="杂谈_赵老师博客_当前是第1页">
        <meta name="author" content="web前端赵老师">
        <!--网站关键词、描述添加结束-->
    ...
    <body class="multi category">
        ...
        <!--<script src="/public/default/js/c_html_js_add.php" type="text/javascript"></script>-->
