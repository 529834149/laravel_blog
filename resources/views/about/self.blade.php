...
<head>
	<meta charset="UTF-8">
	<title>个人介绍</title>
        <link rel="stylesheet" type="text/css" href="/public/default/about_self/css/main.css">
</head>
<body>
<aside>
...
<!--					<li><a href="#"></a></li> 
	...
	<div class="cen_con">
		<div class="portrait">
            <img onmousemove="this.src='/public/default/about_self/images/22.png'"/ onmouseout="this.src='/public/default/about_self/images/portrait1.jpg'"/ src="/public/default/about_self/images/portrait1.jpg">
        </div>
		<div class="cen_text">
		...
		<div class="myinfo">
			<table>
				<tbody>
					<tr>
						<td rowspan="6">
							<img src="/public/default/about_self/images/portrait1.jpg">
						</td>
						<td>姓名 | 陈宝金</td>
						<td>手机 | 15510787005</td>
					
					</tr>
					<tr>
						<td>性别 | 男</td>
						<td>邮箱 | chen2018php@163.com</td>
					</tr>
					<tr>
						<td>出生 | 1991.09.10</td>
					...
					<tr>
						<td colspan="3">
							<p>项目：</p><br>
							<a href="http://www.blogchina.com/">1. 博客中国（基于laravel框架开发 查看网址：http://www.blogchina.com/）</a><br>
                                                        <a href="http://m.blogchina.com/bc_mobile/index.html">2. 博客中国手机端（基于接口开发，前端采用Framework7，php接口采用laravelApi 查看网址：http://m.blogchina.com/bc_mobile/index.html/）</a><br>
							<a href="">3. 潘江物流内部OA系统（基于nodeJS+thinkphp，前端采用Framework7，php接口采用laravelApi 查看网址：内部原因无法展示）</a><br>
                                                        <a>4. 智慧阅读（基于微信公众号、蜂巢学院、smartreader、后台数据采集等4部分组成）</a><br><br>
                                                        <a href="http://www.blogchina.com/">5.个人博客（基于lnmp+laravel+mysql开发 查看网址：http://www.bodys.top）</a><br>
						</td>
					</tr>
				</tbody>
			</table>
...
<section class="page_four" id="page4">
    <div class="con_wrap">
		<div class="tit_wrap">
	  	...
	  	<div class="work_con">
	  		<div class="programe">
		    	<div class="work_time">2年<br>博客中国</div>
			    <div class="work_text">
	...
	<div class="con_wrap">
		...
		<div class="contact_detail">
			...
			<div class="contact_info">
				...
				<label>
					<input type="text" id="username" placeholder="公司名称" required="">
				...
				<label>
					<input type="text" id="usertheme" placeholder="职位" required="" maxlength="25">
					<p id="check_usertheme"></p>
				</label>	
				<label>
					<textarea id="usercon" placeholder="具体介绍" required=""></textarea>
...
<script type="text/javascript" src="/public/default/about_self/js/main.js"></script>
</html>
