...
$(function(){
        ...
        var contenturl ='http://www.bodys.top/article/{{$article['aid']}}'  //获取当前网站的url
        var url = location.href.split('#')[0];
        console.log(url);
        var title = '{{$article['article_title']}}';
        var logo = '/public/picture/201712181513585918126628.jpg';//获取网站Logo信息
        var content ='www.bodys.top，移动开发，laravel后台开发，web前端开发，服务器，版本控制器，功能知识点，css教程等技术大家相互学习' ;//获取分享好友title中的|后面的信息 
        $.ajax({
                ...
                if(msg.code == 'A0200'){ 
                    ...
                    wx.ready(function(){ 
                           ...
                           wx.onMenuShareTimeline({
                                title: 'Bodys技术博客',
                                link: msg.data.url,
                                imgUrl: 'http://www.bodys.top/public/picture/201712181513585918126628.jpg', 
                           ...
                           wx.onMenuShareAppMessage({
                                title: 'Bodys技术博客', 						// 分享标题
                                desc: 'Bodys技术博客-2018CBJ', 						// 分享描述
                                link: location.href.split('#')[0],							// 分享链接
                                imgUrl: 'http://www.bodys.top/public/picture/201712181513585918126628.jpg', 							// 分享图标
